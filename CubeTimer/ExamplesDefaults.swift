...
// Citation: https://github.com/i-schuetz/SwiftCharts/blob/master/Examples/Examples/ExamplesDefaults.swift
...
struct ExamplesDefaults {
    ...
    static func chartFrame(containerBounds: CGRect) -> CGRect {
        return CGRect(x: 0, y: 70, width: containerBounds.size.width, height: containerBounds.size.height - 120)
    }
